...
Test.prototype.call = function call(env, callback) {
  ...
  // NOTICE: we are using linear waterfall instead of parallel calls via
  // promises because most of the values are kept in the memory so there
  // will be no long delays at all and those parallel asynchronous execution
  // is meaningless

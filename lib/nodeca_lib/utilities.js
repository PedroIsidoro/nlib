...
//// TEMPORARY EXTENSION TO UNDERSCORE (until they got merged into upstream) ///
////////////////////////////////////////////////////////////////////////////////


if (_.delete) { warn("_.delete got merged into upstream"); }
...
if (_.uncamelize) { warn("_.uncamelize got merged into upstream"); }

_.uncamelize = function uncamelize(str) {

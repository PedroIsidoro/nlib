...
//
//      var init_dummy_plugin = function init_dummy_plugin(options) {
...
//      };
//
//      module.exports = init_dummy_plugin();
//      module.exports.init = init_dummy_plugin;

// TODO: Add API docks to all plugins

module.exports.gzip = require('./plugins/gzip');
module.exports.sha1 = require('./plugins/sha1');

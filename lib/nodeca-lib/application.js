...
var Application = module.exports = function Application(dirname, bootstrapper) {
  ...
  *  - When failed to create database (upon bootstrap).
  *  - When thrown by bootstrapper (upon bootstrap).
  *  - When thrown upon schemas init.
  *  - When duplicate schema name met.
  *  - When thrown upon models init.
  *  - When duplicate model name met.
  *  - When thrown upon controllers init.
  *  - When duplicate controller name met.
  *  - When thrown upon routes init.

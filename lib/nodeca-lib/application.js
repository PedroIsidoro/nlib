...
var Application = module.exports = function Application(dirname, bootstrapper) {
  var self = this, // self-reference
      ...
      dispatcher, // instance of ExpressRailer.Dispatcher, see init()
  ...
  /**
   *  Application#require(name) -> Module
   *
   *  Exposed `require` method of nodeca-lib.
   **/
  ...
  this.embedInto = function embedInto(mainApp) {
    ...
    // resolve some of local promises with main app
  ...
  this.init = function init(appConfig, callback) {
    ...
    // init some base objects
    apps = {};
    schemas = {};
    models = {};
    controllers = {};
    dispatcher = new ExpressRailer.Dispatcher();
    routers = {};
